...
C<Parse::Lex> - Générateur d'analyseurs lexicaux (Alpha 1.13).
...
segmenter la chaîne "1+2" on peut par exemple écrire : 
...
reconnu.  Retourne l'objet Token::EOI en fin de données.
